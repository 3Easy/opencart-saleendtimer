...
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/easy/stylesheet/ie6.css" />
...
<div id="header">
  <div class="div1">
    ...
    <div class="div3"><a href="<?php echo str_replace('&', '&amp;', $special); ?>" style="background-image: url('catalog/view/theme/easy/image/special.png');"><?php echo $text_special; ?></a><a onclick="bookmark(document.location, '<?php echo addslashes($title); ?>');" style="background-image: url('catalog/view/theme/easy/image/bookmark.png');"><?php echo $text_bookmark; ?></a><a href="<?php echo str_replace('&', '&amp;', $contact); ?>" style="background-image: url('catalog/view/theme/easy/image/contact.png');"><?php echo $text_contact; ?></a><a href="<?php echo str_replace('&', '&amp;', $sitemap); ?>" style="background-image: url('catalog/view/theme/easy/image/sitemap.png');"><?php echo $text_sitemap; ?></a></div>
